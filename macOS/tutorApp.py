...
logging.basicConfig(
    filename=cwd + '/log.txt', level=logging.INFO, format="%(asctime)s - %(message)s"
)
...
class UNABScripts(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(cwd + '/icon.png'))
        ...
        try:
            with open(cwd + '/savefile.json', "r") as file:
                data = load(
                    file,
    ...
    def closeEvent(self, *args, **kwargs):
        ...
        with open(cwd + '/savefile.json', "w") as file:
            dump(data, file)
...
class TabsWidget(QWidget):
    ...
    def __init__(self, parent, savefile=None):
        ...
        image_unab = QPixmap(cwd + '/banner.png')
